...
Source Server         : 192.168.101.234
Source Server Version : 50517
Source Host           : 192.168.101.234:3306
Source Database       : iqrtz

Target Server Type    : MYSQL
Target Server Version : 50517
File Encoding         : 65001

Date: 2014-08-22 10:49:24
*/
...
-- ----------------------------
INSERT INTO `qrtz_cron_triggers` VALUES ('DefaultQuartzScheduler', 'MyJob_Trigger_1', 'DEFAULT', '0 0/5 * * * ?', 'Asia/Shanghai');
INSERT INTO `qrtz_cron_triggers` VALUES ('DefaultQuartzScheduler', 'YourJob_Trigger_1', 'DEFAULT', '0 0/5 * * * ?', 'Asia/Shanghai');
...
-- ----------------------------
INSERT INTO `qrtz_job_details` VALUES ('DefaultQuartzScheduler', 'MyJob', 'DEFAULT', '测试任务1$这是测试任务1', 'com.cetc.cqgs.iquartz.job.MyJob', '0', '0', '0', '0', 0x230D0A23546875204175672032312031303A32373A35352043535420323031340D0A70323D320D0A70313D310D0A);
INSERT INTO `qrtz_job_details` VALUES ('DefaultQuartzScheduler', 'YourJob', 'DEFAULT', '测试任务2$这是测试任务2', 'com.cetc.cqgs.iquartz.job.YourJob', '0', '1', '1', '0', 0x230D0A23546875204175672032312031303A33303A30302043535420323031340D0A70617373776F72643D3132330D0A757365726E616D653D3132330D0A);

-- ----------------------------
-- Table structure for `qrtz_job_logs`
-- ----------------------------
DROP TABLE IF EXISTS `qrtz_job_logs`;
CREATE TABLE `qrtz_job_logs` (
  `logid` int(11) NOT NULL AUTO_INCREMENT,
  `jobname` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `triggername` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `startdate` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `enddate` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `exception` varchar(10240) COLLATE utf8_bin DEFAULT NULL,
  `jobresult` int(1) DEFAULT NULL,
  `info` varchar(1024) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`logid`)
) ENGINE=InnoDB AUTO_INCREMENT=312 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- ----------------------------
-- Records of qrtz_job_logs
-- ----------------------------
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('DefaultQuartzScheduler', 'MyJob_Trigger_1', 'DEFAULT', 'MyJob', 'DEFAULT', '每隔5分钟执行一次', '1408590000000', '1408589700000', '5', 'WAITING', 'CRON', '1408588075000', '0', null, '0', '');
INSERT INTO `qrtz_triggers` VALUES ('DefaultQuartzScheduler', 'YourJob_Trigger_1', 'DEFAULT', 'YourJob', 'DEFAULT', '每隔5分钟执行一次', '1408590000000', '1408589700000', '5', 'WAITING', 'CRON', '1408588080000', '0', null, '0', '');
